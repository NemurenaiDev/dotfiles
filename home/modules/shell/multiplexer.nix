  ...
  xdg.configFile."zellij/config.kdl".text = ''
        keybinds clear-defaults=true {
          ...
          normal {
            ...
            bind "Ctrl Alt left" { MovePane "left"; }
            bind "Ctrl Alt down" { MovePane "down"; }
            bind "Ctrl Alt up" { MovePane "up"; }
            bind "Ctrl Alt right" { MovePane "right"; }


            bind "Ctrl t" { NewTab; }

            bind "Ctrl Shift w" { CloseTab; }
            bind "Alt Shift e" { GoToNextTab; }
            bind "Alt Shift q" { GoToPreviousTab; }
